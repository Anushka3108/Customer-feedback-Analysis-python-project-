...
if uploaded_file:
    # Read the CSV file
    df = pd.read_csv(r"C:\Users\Administrator\Downloads\Experiments\Customer Feedback Analysis python\Customer Feedback Analysis python\customer_feedback_200_rows.csv")
